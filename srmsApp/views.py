...
context={
    'page':'',
    'page_title':'',
    'system_name':'Don Bosco Institute Of Technology',
    'short_name':'DBIT',
    'has_navigation':True,
    'has_sidebar':True,
}
...
def class_mgt(request):
    ...
    context['page_title'] = 'Year Management'
...
def save_class(request):
    ...
    if not request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            resp['status'] = 'success'
            messages.success(request, "Year Detail has been saved successfully.")
        else:
            resp['msg'] = 'Year Detail has failed to save.'
            for field in form:
...
def delete_class(request):
    ...
    if not request.method == 'POST':
        ...
        try:
            ...
            resp['status'] = 'success'
            messages.success(request, "Year Detail has been deleted successfully.")
        except:
            resp['msg'] = 'Year Detail has failed to delete.'
